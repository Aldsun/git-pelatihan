...
WebUI.verifyElementPresent(findTestObject('Login/iPassw0rd'), 0)

WebUI.setText(findTestObject('Login/iUsername'), 'John Doe')

WebUI.setText(findTestObject('Login/iPassw0rd'), 'ThisIsNotAPassword')

WebUI.click(findTestObject('Login/button_Login'))

WebUI.verifyElementPresent(findTestObject('BookAppointment/button_BookAppointment'), 0)
